      ...
      '/fullstack/': [
        {
          ...
          items: [
            ...
            { text: 'Frontend Metadata Back to Backend', link: '/fullstack/frontend-metadata-to-backend' },
            { text: 'Edition Collaboration Differences', link: '/fullstack/edition-collaboration-differences' },
          ],
        },
      ],
      '/backend/': [
        {
          ...
          items: [
            ...
            { text: 'Multi-Database and Datasource Guide', link: '/backend/multi-database-datasource' },
