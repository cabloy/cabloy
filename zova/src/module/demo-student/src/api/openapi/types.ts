export interface paths {
  ...
  '/api/demo/student/summary/{id}': {
    ...
    get: operations['DemoStudent_summary'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  '/api/demo/student/deleteForce/{id}': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    put?: never;
    post?: never;
    delete: operations['DemoStudent_deleteForce'];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
...
export interface components {
  schemas: {
    ...
    'demo-student.dto.studentSelectRes': {
      list: components['schemas']['demo-student.dto.studentSelectResItem'][];
      total: string;
      pageCount: number;
      pageSize: number;
      pageNo: number;
    };
    'demo-student.dto.studentSelectResItem': {
      /**
       * Format: date-time
       * @description Created At
       */
    ...
    'demo-student.dto.studentSummary_2d063d28bc7243bed02ebd8bddf1212a93c6305b':
      | {
          id: number | string;
          /** @description Name */
          name: string;
      ...
      | undefined;
    'demo-student.dto.studentView_2d063d28bc7243bed02ebd8bddf1212a93c6305b':
      | {
          /**
           * Format: date-time
           * @description Created At
      ...
      200: {
        ...
        content: {
          'application/json': {
            code: string;
            message: string;
            data: components['schemas']['demo-student.dto.studentSelectRes'];
          };
        };
      };
    };
      ...
      200: {
        ...
        content: {
          'application/json': {
            code: string;
            message: string;
            data?: components['schemas']['demo-student.dto.studentSummary_2d063d28bc7243bed02ebd8bddf1212a93c6305b'];
          };
        };
      };
    };
      ...
      200: {
        ...
        content: {
          'application/json': {
            code: string;
            message: string;
            data?: components['schemas']['demo-student.dto.studentView_2d063d28bc7243bed02ebd8bddf1212a93c6305b'];
          };
        };
      };
    };
