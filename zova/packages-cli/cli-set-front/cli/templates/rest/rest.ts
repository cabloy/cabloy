...
import type { IFormLayout, IResourceFormFieldLayoutOptions } from 'zova-module-a-openapi';
...
export function schemaRenderFormLayout(layout: IFormLayout): IFormLayout {
  return layout;
}
