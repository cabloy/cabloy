...
- [ADR 0010](../../repo-docs-internal/decisions/0010-repository-native-planning-documents.md) owns the repository-wide decision to retain internal planning documents and not adopt OpenSpec as a parallel planning authority.
...
- [Fullstack SSR and bidirectional type-flow ADR](../../repo-docs-internal/decisions/0004-fullstack-ssr-and-bidirectional-type-flow.md)
- [SSR site access and role model ADR](../../repo-docs-internal/decisions/0006-ssr-site-access-and-role-model.md) — proposed guidance
- [SSR Vona/Zova boundary and call chain](../../repo-docs-internal/architecture/ssr-vona-zova-boundary-and-call-chain.md)
- [User workspace SSR strategy](../../repo-docs-internal/architecture/user-workspace-ssr-strategy.md)
- [Zova SSR payment return and Passport recovery](../../repo-docs-internal/architecture/zova-ssr-payment-return-passport-recovery.md)
- [Resource custom-API state ownership](../../repo-docs-internal/architecture/resource-custom-api-state-ownership.md)
