...
- `cabloy-docs/frontend/use-state-data-best-practices.md`
- `cabloy-docs/frontend/model-state-guide.md`
- `cabloy-docs/frontend/resource-entry-page-deep-dive.md`
- `cabloy-docs/frontend/model-resource-internals-deep-dive.md`
...
Keep the full investigation here in `.docs-internal/` because it includes:
