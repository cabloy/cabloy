...
4. Approve with the corresponding Sandbox buyer account. The browser returns through `/api/pay/payment-callback/return`; it cannot settle the order directly.
