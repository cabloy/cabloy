...
| WBS / ATP scope                                                                    | Traceability                                                                                  | Revision / database / flavor                        | Command                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Retained evidence                                                                             | Status              |
| ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------------------- |
| `WBS-40-02` coupon reservation subset; `WBS-40-03` checkout/expiry/rollback subset | `SRS-CPN-01`–`SRS-CPN-03`; `SRS-INV-01`–`SRS-INV-03`; `SRS-TXN-01`–`SRS-TXN-03`; WBS-40-02/03 | Local working tree; SQLite and PostgreSQL; `normal` | SQLite: `DATABASE_DEFAULT_CLIENT=sqlite3 npm run vona :bin:test -- commerce-trade/test/checkoutReservation.test.ts commerce-trade/test/checkoutTransaction.test.ts commerce-trade/test/orderSnapshot.test.ts commerce-trade/test/reservationExpiry.test.ts commerce-promotion/test/couponReservation.test.ts commerce-payment/test/paymentAttempt.test.ts --flavor=normal`; PostgreSQL: run `checkoutReservation.test.ts`, `checkoutTransaction.test.ts`, and `reservationExpiry.test.ts` as separate focused commands with `DATABASE_DEFAULT_CLIENT=pg`. | SQLite: 11 passed and 1 PostgreSQL-only checkout-contention skip. PostgreSQL: checkout contention proves one final-unit winner with one order/payment/reservation and the loser cart intact; six injected failures after snapshot, coupon, stock, payment, order-audit, and cart mutation fully roll back and then permit the same correlation to succeed; coupon expiry releases coupon/stock once and cancels payment. Coupon tests also cover the 80-character issuance-correlation boundary, foreign-customer denial, and one-coupon-per-order persistence. | Local command output at `f04b9525bf`, 2026-07-23; CI gates now run isolated focused commands. | Scoped local passed |

This evidence closes the current checkout-contention and injected-rollback portions of `ATP-INV-01` and `ATP-TXN-01`, but does not close full `ATP-CPN-01`, `ATP-TEN-01`, `ATP-SNAP-01`, or `ATP-EXP-01`: the remaining coupon invalid/expired/exhausted and tenant matrix, checkout-path cross-tenant proof, checkout-path immutable snapshot view, and the Phase-50 payment-success-versus-expiry race remain open. The Commerce promotion OpenAPI consumer and paired SSR/REST artifacts were regenerated with `npm run zova :openapi:generate commerce-promotion`, `npm run build:zova:commerce`, and `npm run deps:vona`; `npm run test` passed 166 tests with 2 PostgreSQL-only skips after recreating the SQLite test database.
