...
| WBS / ATP scope                                                           | Traceability                                                       | Revision / database / flavor                        | Command                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Result                                                                                                                                                                                                                                                                        | Retained evidence                 | Status              |
| ------------------------------------------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | ------------------- |
| `WBS-40-02` coupon reservation subset; `WBS-40-03` checkout/expiry subset | `SRS-CPN-01`–`SRS-CPN-03`; `SRS-TXN-01`–`SRS-TXN-03`; WBS-40-02/03 | Local working tree; SQLite and PostgreSQL; `normal` | `DATABASE_DEFAULT_CLIENT=sqlite3 npm run vona -- :bin:test commerce-trade/test/stockBalance.test.ts commerce-trade/test/stockReservation.test.ts commerce-trade/test/stockAudit.test.ts commerce-promotion/test/couponReservation.test.ts commerce-payment/test/paymentAttempt.test.ts commerce-trade/test/checkoutReservation.test.ts commerce-trade/test/reservationExpiry.test.ts --flavor=normal`; repeat with `DATABASE_DEFAULT_CLIENT=pg TEST_CONCURRENCY=false` | SQLite: 15 passed and 1 PostgreSQL-only contention skip. PostgreSQL: all 16 passed. The focused suite proves stock primitive behavior, coupon release replay, cart-authoritative checkout replay, minimal payment-attempt cancellation, and exact-once unpaid expiry release. | Local command output, 2026-07-23. | Scoped local passed |

This evidence does not close `ATP-INV-01`, `ATP-TXN-01`, full `ATP-CPN-01`, or `ATP-EXP-01`: it lacks competing checkout, injected checkout-stage rollback, the remaining invalid/tenant coupon matrix, and the Phase-50 payment-success-versus-expiry race. The generated Commerce contract and paired SSR/REST artifacts were refreshed with `npm run build:zova:commerce && npm run deps:vona`; `npm run test` also passed 155 tests with 1 PostgreSQL-only skip after recreating the SQLite test database.
