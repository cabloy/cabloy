...
6. [Commerce Address Admin/Web Remediation Checklist](../../architecture/commerce-address-admin-web-remediation-checklist.md) records the required contract, ownership, state, page, and verification split before Address gains independent operator and customer surfaces.
