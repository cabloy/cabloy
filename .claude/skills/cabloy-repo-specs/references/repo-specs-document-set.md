...
This reference defines the standard generated by `cabloy-repo-specs`. It is distilled from the suite records in `repo-specs/a-commerce`, `repo-specs/home-user`, and Cabloy Start's `repo-specs/cabloy-admin`.
