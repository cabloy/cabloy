...
module.exports = app => {
  ...
  // models
  const models = __webpack_require__(57)(app);
  // meta
  const meta = __webpack_require__(61)(app);
...
const testKitchensinkAutocomplete = __webpack_require__(46);
const testKitchensinkGuide = __webpack_require__(48);
const testKitchensinkFormSchemaValidation = __webpack_require__(49);
const testKitchensinkPtrIsLoadMore = __webpack_require__(50);
...
const languages = __webpack_require__(47);
...
const party = __webpack_require__(55);
const partyPublic = __webpack_require__(56);
...
const VersionTestFn = __webpack_require__(53);
...
const testData = __webpack_require__(54);
...
const party = __webpack_require__(58);
const partyType = __webpack_require__(59);
...
module.exports = app => {
  ...
  if (app.meta.isTest || app.meta.isLocal) {
    // schemas
    const schemas = __webpack_require__(62)(app);
    // keywords
    const keywords = __webpack_require__(63)(app);
    // meta
    extend(true, meta, {
      base: {
        atoms: {
