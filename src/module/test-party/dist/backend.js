...
/** ****/ (function(modules) { // webpackBootstrap
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      module.exports = app => {
        ...
        // aops
        const aops = __webpack_require__(9)(app);
        // beans
        const beans = __webpack_require__(12)(app);
        // routes
        const routes = __webpack_require__(22)(app);
        // controllers
        const controllers = __webpack_require__(23)(app);
        // services
        const services = __webpack_require__(67)(app);
        // models
...
module.exports = appInfo => {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const regExp = __webpack_require__(10);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const testApp = __webpack_require__(13);
      const testClass = __webpack_require__(14);
      const testCtx = __webpack_require__(15);
      const eventLoginInfoDashboard = __webpack_require__(16);
      const eventHelloEcho = __webpack_require__(18);
      const eventUserVerify = __webpack_require__(19);
      const eventLoginInfo = __webpack_require__(20);
      const broadcastTest = __webpack_require__(21);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const dashboardProfileDefault = __webpack_require__(17);
      ...
      module.exports = app => {
        ...
        if (app.meta.isTest || app.meta.isLocal) {
          routes = routes.concat([
            ...
            { method: 'post', path: 'partyPublic/read', controller: 'partyPublic', middlewares: 'inner', meta: { auth: { enable: false } } },
            { method: 'post', path: 'partyPublic/select', controller: 'partyPublic', middlewares: 'inner', meta: { auth: { enable: false } } },
            ...
            { method: 'post', path: 'partyPublic/action', controller: 'partyPublic', middlewares: 'inner', meta: { auth: { enable: false } } },
            { method: 'post', path: 'partyPublic/enable', controller: 'partyPublic', middlewares: 'inner', meta: { auth: { enable: false } } },
            ...
            { method: 'post', path: 'test/function/checkRightFunctionUser', controller: 'testFunctionRight', middlewares: 'test',
              meta: { right: { type: 'resource', module: 'a-baseadmin', name: 'user' } },
            },
            // test/function/all
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const party = __webpack_require__(25);
      const partyPublic = __webpack_require__(26);
      const testAtomStarLabel = __webpack_require__(27);
      const testAtomAll = __webpack_require__(28);
      const testAtomPublicFlow = __webpack_require__(29);
      const testAtomRight = __webpack_require__(30);
      const testFunctionRight = __webpack_require__(31);
      const testFunctionAll = __webpack_require__(32);
      const testFunctionPublic = __webpack_require__(33);
      const testCtxPerformAction = __webpack_require__(34);
      const testCtxTransaction = __webpack_require__(35);
      const testCtxTail = __webpack_require__(36);
      const testCtxSession = __webpack_require__(37);
      const testCtxRequest = __webpack_require__(38);
      const testCtxResponse = __webpack_require__(39);
      const testCtxConfig = __webpack_require__(40);
      const testCtxLocale = __webpack_require__(41);
      const testCacheMem = __webpack_require__(42);
      const testCacheDb = __webpack_require__(43);
      const testCacheRedis = __webpack_require__(44);
      const testRoleUserRole = __webpack_require__(45);
      const testEventHello = __webpack_require__(46);
      const testFeatBean = __webpack_require__(47);
      const testFeatHttpLog = __webpack_require__(48);
      const testFeatStartup = __webpack_require__(49);
      const testFeatSendMail = __webpack_require__(50);
      const testFeatSocketIO = __webpack_require__(51);
      const testFeatInstance = __webpack_require__(52);
      const testFeatProgress = __webpack_require__(53);
      const testFeatSequence = __webpack_require__(54);
      const testFeatSettings = __webpack_require__(55);
      const testFeatStatus = __webpack_require__(56);
      const testFeatValidation = __webpack_require__(57);
      const testFeatMiddleware = __webpack_require__(58);
      const testFeatQueue = __webpack_require__(59);
      const testFeatBroadcast = __webpack_require__(60);
      const testMonkeyee = __webpack_require__(61);
      const testKitchensinkAutocomplete = __webpack_require__(62);
      const testKitchensinkGuide = __webpack_require__(64);
      const testKitchensinkFormSchemaValidation = __webpack_require__(65);
      const testKitchensinkPtrIsLoadMore = __webpack_require__(66);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const languages = __webpack_require__(63);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const version = __webpack_require__(68);
      const party = __webpack_require__(71);
      const partyPublic = __webpack_require__(72);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const VersionTestFn = __webpack_require__(69);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const testData = __webpack_require__(70);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const party = __webpack_require__(74);
      const partyType = __webpack_require__(75);
      const partyPublic = __webpack_require__(76);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      module.exports = app => {
        ...
        if (app.meta.isTest || app.meta.isLocal) {
          // schemas
          const schemas = __webpack_require__(78)(app);
          // keywords
          const keywords = __webpack_require__(79)(app);
          // socketio
          const socketioTest = __webpack_require__(80)(app);
          // meta
          extend(true, meta, {
            base: {
              atoms: {
