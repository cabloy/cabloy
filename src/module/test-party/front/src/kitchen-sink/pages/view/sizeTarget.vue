<template>
  <eb-page>
    <eb-navbar :title="$text('View Size & Open Target')" eb-back-link="Back"></eb-navbar>
    <eb-list no-hairlines-md>
      ...
      <eb-list-item title="Middle" link="#" eb-href="kitchen-sink/view/sizeMiddle"></eb-list-item>
      ...
      <eb-list-item title="_self(Middle)" link="#" :onPerform="onPerformOpenTargetSelf"></eb-list-item>
      <eb-list-item title="_group" link="#" :onPerform="onPerformOpenTargetGroup"></eb-list-item>
    </eb-list>
  </eb-page>
</template>
<script>
export default {
  ...
  methods: {
    onPerformOpenTargetSelf() {
      this.$view.navigate('/test/party/kitchen-sink/view/sizeMiddle', {
        target: '_self',
      });
    },
    onPerformOpenTargetGroup() {
      this.$view.navigate('/test/party/kitchen-sink/view/sizeLarge', {
        target: '_group',
      });
    },
  },
