<template>
  <eb-page>
    ...
    <f7-block>
      <p>In addition to usual <eb-link eb-href="kitchen-sink/framework7/cards">Cards</eb-link> there are also Expandable Cards that allow to store more information and illustrations about particular subject.</p>
    </f7-block>
