<template>
  <eb-page @page:beforeremove="onPageBeforeRemove" @page:init="onPageInit">
    <eb-navbar :title="$text('Autocomplete')" eb-back-link="Back">
      <div class="subnavbar">
    ...
    <div class="block">
      <p>Standalone autocomplete provides better mobile UX by opening it in a new page. Good to use when you need to get strict values without allowing free-type values.</p>
    </div>
    <div class="list">
