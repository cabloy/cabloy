<template>
  <eb-page>
    ...
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="wheePickerValue" @colorpicker:change="(value) => wheePickerValue = value" :color-picker-params="{
          targetEl: '.wheel-picker-target'
        }">
        <i slot="media" :style="`background-color: ${wheePickerValue.hex}`" class="icon demo-list-icon wheel-picker-target"></i>
      </f7-list-input>
    </f7-list>
    ...
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="spectrumPickerValue" @colorpicker:change="(value) => spectrumPickerValue = value" :color-picker-params="{
          modules: ['sb-spectrum', 'hue-slider'],
          targetEl: '.spectrum-picker-target'
        }">
        <i slot="media" :style="`background-color: ${spectrumPickerValue.hex}`" class="icon demo-list-icon spectrum-picker-target"></i>
      </f7-list-input>
    </f7-list>
    ...
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="hsSpectrumPickerValue" @colorpicker:change="(value) => hsSpectrumPickerValue = value" :color-picker-params="{
          modules: ['hs-spectrum', 'brightness-slider'],
          targetEl: '.hs-spectrum-picker-target'
        }">
        <i slot="media" :style="`background-color: ${hsSpectrumPickerValue.hex}`" class="icon demo-list-icon hs-spectrum-picker-target"></i>
      </f7-list-input>
    </f7-list>
    <f7-block-title>RGB Sliders</f7-block-title>
    <f7-block-header>RGB sliders with labels and values in Popover</f7-block-header>
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="rgbPickerValue" @colorpicker:change="(value) => rgbPickerValue = value" :color-picker-params="{
          modules: ['rgb-sliders'],
          sliderValue: true,
          sliderLabel: true,
          targetEl: '.rgb-picker-target',
        }">
        <i slot="media" :style="`background-color: ${rgbPickerValue.hex}`" class="icon demo-list-icon rgb-picker-target"></i>
      </f7-list-input>
    </f7-list>
    ...
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="rgbaPickerValue" @colorpicker:change="(value) => rgbaPickerValue = value" :color-picker-params="{
        ...
        <i slot="media" :style="`background-color: ${rgbaPickerValue.rgba ? `rgba(${rgbaPickerValue.rgba.join(', ')})` : rgbaPickerValue.hex}`" class="icon demo-list-icon rgba-picker-target"></i>
      </f7-list-input>
    </f7-list>
    <f7-block-title>HSB Sliders</f7-block-title>
    <f7-block-header>HSB sliders with labels and values in Popover</f7-block-header>
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="hsbPickerValue" @colorpicker:change="(value) => hsbPickerValue = value" :color-picker-params="{
          modules: ['hsb-sliders'],
          sliderValue: true,
          sliderLabel: true,
        ...
        <i slot="media" :style="`background-color: ${hsbPickerValue.hex}`" class="icon demo-list-icon hsb-picker-target"></i>
      </f7-list-input>
    </f7-list>
    ...
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="rgbBarsPickerValue" @colorpicker:change="(value) => rgbBarsPickerValue = value" :color-picker-params="{
          modules: ['rgb-bars'],
          openIn: 'auto',
          barValue: true,
          barLabel: true,
        ...
        <i slot="media" :style="`background-color: ${rgbBarsPickerValue.hex}`" class="icon demo-list-icon rgb-bars-picker-target"></i>
      </f7-list-input>
    </f7-list>
    ...
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="rgbSlidersColorsPickerValue" @colorpicker:change="(value) => rgbSlidersColorsPickerValue = value" :color-picker-params="{
        ...
        <i slot="media" :style="`background-color: ${rgbSlidersColorsPickerValue.hex}`" class="icon demo-list-icon rgb-sliders-colors-picker-target"></i>
      </f7-list-input>
    </f7-list>
    ...
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="palettePickerValue" @colorpicker:change="(value) => palettePickerValue = value" :color-picker-params="{
          modules: ['palette'],
          openIn: 'auto',
          openInPhone: 'sheet',
          palette: [
        ...
        <i slot="media" :style="`background-color: ${palettePickerValue.hex}`" class="icon demo-list-icon palette-picker-target"></i>
      </f7-list-input>
    </f7-list>
    ...
    <f7-list no-hairlines-md>
      <f7-list-input type="colorpicker" placeholder="Color" readonly :value="proPickerValue" @colorpicker:change="(value) => proPickerValue = value" :color-picker-params="{
        ...
        <i slot="media" :style="`background-color: ${proPickerValue.rgba ? `rgba(${proPickerValue.rgba.join(', ')})` : proPickerValue.hex}`" class="icon demo-list-icon pro-picker-target"></i>
      </f7-list-input>
    </f7-list>
