    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      module.exports = app => {
        let routes = [
          ...
          { method: 'post', path: 'site/buildLanguage', controller: 'site', middlewares: 'progress', meta: { right: { type: 'resource', module: 'a-settings', name: 'settings' } } },
          { method: 'post', path: 'site/buildLanguages', controller: 'site', middlewares: 'progress', meta: { right: { type: 'resource', module: 'a-settings', name: 'settings' } } },
