module.exports = ctx => {
  class Procedure {
    ...
    async checkRightRead({ iid, userIdWho, atomClass, atomClassBase, atomId, forAtomUser }) {
      return await this.checkRightAction({ iid, userIdWho, atomClass, atomClassBase, atomId, action: 2, forAtomUser });
    }
