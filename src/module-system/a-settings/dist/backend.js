...
module.exports = app => {
  ...
  if (app.meta.isTest) {
    // schemas
    const schemas = __webpack_require__(9)(app);
    // keywords
    const keywords = __webpack_require__(8)(app);
    // meta
    extend(true, meta, {
      settings: {
        user: {
...
const require3 = __webpack_require__(0);
const extend = require3('extend2');
const modelSettingsFn = __webpack_require__(3);
...
const SettingsFn = __webpack_require__(11);
...
const settings = __webpack_require__(12);
