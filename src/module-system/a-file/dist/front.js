...
/* harmony import */ var cropperjs_dist_cropper_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
/* harmony import */ var _assets_css_module_less__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
...
function install(_Vue, cb) {
  ...
  return cb({
    ...
    components: __webpack_require__(14)["default"]
  });
}
...
// EXTERNAL MODULE: /Users/wind/Documents/data/cabloy/egg-born-demo/node_modules/cropperjs/dist/cropper.js
var cropper = __webpack_require__(3);
...
/* harmony default export */ var uploadvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    title: function title() {
      if (this.mode === 1) return this.$text('Upload Image');else if (this.mode === 2) return this.$text('Upload File');else if (this.mode === 3) return this.$text('Upload Audio');
    },
    selectText: function selectText() {
      if (this.mode === 1) return this.$text('Select Image');else if (this.mode === 2) return this.$text('Select File');else if (this.mode === 3) return this.$text('Select Audio');
    },
  ...
  methods: {
    createCropper: function createCropper() {
      ...
      if (this.mode === 1) {
        this._cropper = new cropper_default.a(this.$refs.image, {
          viewMode: 3,
...
var uploadvue_type_style_index_0_id_a3a708f2_lang_less_scoped_true_ = __webpack_require__(9);
