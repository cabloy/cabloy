...
module.exports = {
  ...
  business: 'coupon,course,distribution,kitchen-set,money-bag,party,provider,purchase,store',
  default: 'add,archive,arrow-back,arrow-cycle,arrow-down-left,arrow-down-right,arrow-down,arrow-drop-down,arrow-drop-up,arrow-forward,arrow-left,arrow-repeat,arrow-right-left,arrow-right,arrow-shuffle,arrow-up-down,arrow-up-left,arrow-up-right,arrow-up,article,attachment-line,checkbox-checked,checkbox-intermediate,checkbox-off,checkbox,chevron-left,chevron-right,close,comment-dots,construction,copyright,cross-circle,dashboard,database,delete-forever,delete,developer-board,done,dot,draft,drive-file-move,edit,expand-more,export,fast-forward,flow-chart,folder-open,folder,fullscreen-exit,fullscreen,grading,group-work,group,groups,heart,home,import,info-circle,label,language,layers,location-on,lock-open,lock,mail,mark-as-unread,mark-email-read,menu,message,module,more-horiz,open-in-new,open-with,people,person,play-arrow,preview,radio-button-checked,radio-button-unchecked,redo,remove,reply,save,search,send,settings,share,sort,star,stop,undo,view-list,visibility,zoom-in,zoom-out',
  ...
  outline: 'add-circle-outline,apps-outline,archive-lock-outline,archive-outline,article-outline,build-circle-outline,calendar-today-outline,check-circle-outline,checkbox-checked-outline,checkbox-off-outline,checkbox-outline,copy-outline,data-list-outline,database-lock-outline,delete-forever-outline,delete-outline,dict-outline,draft-outline,folder-transfer-outline,group-outline,heart-outline,insert-emoticon-outline,key-reset-outline,label-outline,layout-outline,log-out-outline,mail-outline,note-outline,software-resource-cluster-outline,software-resource-outline,star-outline,theme-outline,timer-outline,visibility-off-outline,visibility-outline,work-history-outline',
