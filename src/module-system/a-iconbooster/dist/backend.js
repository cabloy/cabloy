...
module.exports = {
  ...
  outline: 'archive-outline,build-circle-outline,calendar-today-outline,check-circle-outline,checkbox-checked-outline,checkbox-off-outline,checkbox-outline,copy-outline,delete-forever-outline,delete-outline,draft-outline,heart-outline,label-outline,mail-outline,star-outline,timer-outline,work-history-outline',
};
