    ...
    <template v-if="builtIn">
      ...
      <f7-list>
        <f7-list-input
          ...
          :placeholder="`${$text('e.g.')} #ff0000`"
          readonly
          :value="{ hex: builtIn.customColor || themeColor }"
          :color-picker-params="{
...
<script>
const colors = ['Red', 'Green', 'Blue', 'Pink', 'Yellow', 'Orange', 'Purple', 'Deeppurple', 'Lightblue', 'Teal', 'Lime', 'Deeporange', 'Gray', 'Black'];
import Vue from 'vue';
