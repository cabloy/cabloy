    ...
    return {
      ...
      token: function (stream, state) {
        ...
        var isClosingAssignment =
          ctx.type == 'assignment' && closingBracket.test(curPunc) && ctx.prev && ctx.prev.type === curPunc;
        if (curPunc == ctx.type || isClosingAssignment) {
          ...
          ((curPunc == ';' || curPunc == ',') && (ctx.type == 'statement' || ctx.type == 'assignment')) ||
      ...
      indent: function (state, textAfter) {
        ...
        else if ((closingBracket.test(ctx.type) || ctx.type == 'assignment') && ctx.align && !dontAlignCalls)
