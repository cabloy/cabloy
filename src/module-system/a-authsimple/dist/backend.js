 ...
 * Module dependencies.
 */
var Strategy = __webpack_require__(2);
...
const strategy = __webpack_require__(4);
module.exports = app => {
...
module.exports = app => {
  const auth = __webpack_require__(5)(app);
  const schemas = __webpack_require__(1)(app);
  return {
    auth,
    validation: {
      validators: {
...
const authProvider = __webpack_require__(12);
const authSimple = __webpack_require__(11);
...
const util = __webpack_require__(0);
const passwordFn = __webpack_require__(17);
module.exports = app => {
