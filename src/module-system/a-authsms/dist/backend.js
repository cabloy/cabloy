      ...
      sendCode(e) {
        const t = this; return o(function* () {
          const { providerInstanceId: n, context: r } = e; const { provider: o, config: i } = t.__createSMSProvider(),
            s = yield o.sendCode({ providerInstanceId: n, context: r, config: i }); yield t.ctx.bean.captcha.update({ providerInstanceId: n, data: s, context: r });
        })();
      ...
      signup(e) {
        const n = this; return r(function* () {
          const { user: r, state: o = 'login', userName: i, realName: s, mobile: a } = e; const c = { module: t.relativeName, provider: 'authsms', profileId: a, maxAge: 0, profile: { mobile: a, rememberMe: !1 } },
            u = yield n.ctx.bean.user.verify({ state: o, profileUser: c }); u || n.ctx.throw(403); const l = u.agent.id,
            d = { id: l }; return i && (o === 'login' || !r.userName || r.userName.indexOf('__') > -1) && (d.userName = i), s && (d.realName = s), yield n.ctx.bean.user.save({ user: d }), yield n.ctx.bean.user.setActivated({ user: { id: l, mobile: a, mobileVerified: 1 } }), yield n.ctx.login(u), u;
        })();
