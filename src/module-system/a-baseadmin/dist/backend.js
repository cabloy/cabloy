    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      module.exports = app => {
        const routes = [
          ...
          // role
          { method: 'post', path: 'role/children', controller: 'role', meta: { right: { type: 'resource', name: 'role' } } },
          ...
          { method: 'post', path: 'role/build', controller: 'role', middlewares: 'progress', meta: { right: { type: 'resource', name: 'role' } } },
          ...
          { method: 'post', path: 'user/functionRights', controller: 'user', meta: { right: { type: 'resource', name: 'user' } } },
          // atomRight
          ...
          // function
          { method: 'post', path: 'function/scenesLoad', controller: '_function', meta: { right: { type: 'resource', name: 'menu' } } },
          { method: 'post', path: 'function/scenesSaveSortings', controller: '_function', meta: { right: { type: 'resource', name: 'menu' } } },
          { method: 'post', path: 'function/sceneItemsLoad', controller: '_function', meta: { right: { type: 'resource', name: 'menu' } } },
          { method: 'post', path: 'function/sceneItemsSaveSortings', controller: '_function', meta: { right: { type: 'resource', name: 'menu' } } },
        ];
        return routes;
      };
