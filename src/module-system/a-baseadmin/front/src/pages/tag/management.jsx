...
export default {
  ...
  methods: {
    async onPerformClick(event, item) {
      ...
      const url = this.$meta.util.combineQueries('/a/baseadmin/tag/list', queries);
  ...
  render() {
    return (
      <eb-page>
        <eb-navbar large largeTransparent title={this.$text('Tag Management')} eb-back-link="Back"></eb-navbar>
