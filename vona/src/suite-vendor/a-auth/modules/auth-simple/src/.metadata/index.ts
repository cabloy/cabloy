...
export type EntityAuthSimpleMeta = TypeEntityMeta<
  EntityAuthSimple,
  EntityAuthSimpleTableName
>;
declare module "vona-module-a-orm" {
...
declare module "vona-module-auth-simple" {
  export interface IEntityOptionsAuthSimple {
    fields?: TypeEntityOptionsFields<
      EntityAuthSimple,
      IEntityOptionsAuthSimple[TypeSymbolKeyFieldsMore]
    >;
  }
}
/** entity: end */
...
declare module "vona-module-auth-simple" {
  export interface ModelAuthSimple {
    ...
    get<T extends IModelGetOptions<EntityAuthSimple, ModelAuthSimple>>(
      where: TypeModelWhere<EntityAuthSimple>,
      options?: T,
    ): Promise<
      TypeModelRelationResult<EntityAuthSimple, ModelAuthSimple, T> | undefined
    >;
    /**
     ...
     */
    getForUpdate<T extends IModelGetOptions<EntityAuthSimple, ModelAuthSimple>>(
      where: TypeModelWhere<EntityAuthSimple>,
      options?: T,
    ): Promise<
      TypeModelRelationResult<EntityAuthSimple, ModelAuthSimple, T> | undefined
     ...
     */
    getByIdForUpdate<
      T extends IModelGetOptions<EntityAuthSimple, ModelAuthSimple>,
    >(
      id: TableIdentity,
      options?: T,
    ): Promise<
      TypeModelRelationResult<EntityAuthSimple, ModelAuthSimple, T> | undefined
    >;
    mget<T extends IModelGetOptions<EntityAuthSimple, ModelAuthSimple>>(
      ids: TableIdentity[],
      options?: T,
    ): Promise<TypeModelRelationResult<EntityAuthSimple, ModelAuthSimple, T>[]>;
    selectAndCount<
      T extends IModelSelectParams<
        EntityAuthSimple,
        ModelAuthSimple,
        ModelJoins
      >,
    ...
    ): Promise<TypeModelSelectAndCount<EntityAuthSimple, ModelAuthSimple, T>>;
    select<
      T extends IModelSelectParams<
        EntityAuthSimple,
        ModelAuthSimple,
    ...
    insert<T extends IModelInsertOptions<EntityAuthSimple, ModelAuthSimple>>(
      data?: TypeModelMutateRelationData<EntityAuthSimple, ModelAuthSimple, T>,
      options?: T,
    ): Promise<
      TypeModelMutateRelationData<EntityAuthSimple, ModelAuthSimple, T, true>
    >;
    insertBulk<
      T extends IModelInsertOptions<EntityAuthSimple, ModelAuthSimple>,
    >(
      items: TypeModelMutateRelationData<
        EntityAuthSimple,
        ModelAuthSimple,
        T
      >[],
      ...
      TypeModelMutateRelationData<EntityAuthSimple, ModelAuthSimple, T, true>[]
    >;
    update<T extends IModelUpdateOptions<EntityAuthSimple, ModelAuthSimple>>(
      data: TypeModelMutateRelationData<EntityAuthSimple, ModelAuthSimple, T>,
      options?: T,
    ): Promise<
      TypeModelMutateRelationData<EntityAuthSimple, ModelAuthSimple, T>
    >;
    updateBulk<
      T extends IModelUpdateOptions<EntityAuthSimple, ModelAuthSimple>,
    >(
      items: TypeModelMutateRelationData<
        EntityAuthSimple,
        ModelAuthSimple,
      ...
      TypeModelMutateRelationData<EntityAuthSimple, ModelAuthSimple, T>[]
    >;
    delete<T extends IModelDeleteOptions<EntityAuthSimple, ModelAuthSimple>>(
      where?: TypeModelWhere<EntityAuthSimple>,
      options?: T,
    ): Promise<void>;
    deleteBulk<
      T extends IModelDeleteOptions<EntityAuthSimple, ModelAuthSimple>,
    >(
      ids: TableIdentity[],
      options?: T,
    ): Promise<void>;
    mutate<T extends IModelMutateOptions<EntityAuthSimple, ModelAuthSimple>>(
      data?: TypeModelMutateRelationData<EntityAuthSimple, ModelAuthSimple, T>,
      options?: T,
    ): Promise<
      TypeModelMutateRelationData<EntityAuthSimple, ModelAuthSimple, T>
    >;
    mutateBulk<
      T extends IModelMutateOptions<EntityAuthSimple, ModelAuthSimple>,
    >(
      items: TypeModelMutateRelationData<
        EntityAuthSimple,
        ModelAuthSimple,
    ...
    >;
    count<
      T extends IModelSelectCountParams<
        EntityAuthSimple,
        ModelAuthSimple,
        ModelJoins
      >,
    ...
    increment<
      T extends IModelIncrementParams<
        EntityAuthSimple,
        ModelAuthSimple,
        ModelJoins
      >,
    ...
    aggregate<
      T extends IModelSelectAggrParams<
        EntityAuthSimple,
        ModelAuthSimple,
        ModelJoins
      >,
    ...
    group<
      T extends IModelSelectGroupParams<
        EntityAuthSimple,
        ModelAuthSimple,
        ModelJoins
      >,
    ...
    >(
      ...
      options?: IModelMethodOptions,
      modelJoins?: ModelJoins,
    ): Promise<TypeModelGroupRelationResult<EntityAuthSimple, T>[]>;
    getById<T extends IModelGetOptions<EntityAuthSimple, ModelAuthSimple>>(
      id: TableIdentity,
      options?: T,
    ): Promise<
      TypeModelRelationResult<EntityAuthSimple, ModelAuthSimple, T> | undefined
