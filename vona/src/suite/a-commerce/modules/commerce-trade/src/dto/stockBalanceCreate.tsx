...
export interface IDtoOptionsStockBalanceCreate extends IDecoratorDtoOptions {}

@Dto<IDtoOptionsStockBalanceCreate>({
  blocks: [
...
export class DtoStockBalanceCreate extends $Dto.create(() => ModelStockBalance) {}
