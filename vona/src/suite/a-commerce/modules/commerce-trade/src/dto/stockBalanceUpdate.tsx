...
export interface IDtoOptionsStockBalanceUpdate extends IDecoratorDtoOptions {}

@Dto<IDtoOptionsStockBalanceUpdate>({
  blocks: [
...
export class DtoStockBalanceUpdate extends $Dto.update(() => ModelStockBalance) {}
