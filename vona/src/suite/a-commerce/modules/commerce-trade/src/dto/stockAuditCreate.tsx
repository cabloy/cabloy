...
export interface IDtoOptionsStockAuditCreate extends IDecoratorDtoOptions {}

@Dto<IDtoOptionsStockAuditCreate>({
  blocks: [
...
export class DtoStockAuditCreate extends $Dto.create(() => ModelStockAudit) {}
