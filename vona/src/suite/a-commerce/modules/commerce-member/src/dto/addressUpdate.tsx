...
export interface IDtoOptionsAddressUpdate extends IDecoratorDtoOptions {}

@Dto<IDtoOptionsAddressUpdate>({
  blocks: [
...
export class DtoAddressUpdate extends $Dto.update(() => ModelAddress, {
  columns: [
    'recipientName',
    'phone',
    'countryCode',
