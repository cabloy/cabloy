...
```bash
$ npm run vona :create:project projectName -- --template=cabloy-start
$ cd projectName
```
...
Modify the environment parameter configuration of the two flavors of `Web` and `Admin` respectively.
