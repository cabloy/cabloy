...
1. Add this ADR and index it from `repo-docs-internal/README.md`; also correct the missing ADR 0005 index entry.
...
- `repo-docs-internal/decisions/0002-guard-permission-projection.md`
- `repo-docs-internal/decisions/0005-current-passport-guard-permission-evaluation.md`
