...
- `repo-docs/` owns user-facing and agent-facing guidance;
- `repo-docs-internal/` owns maintainer rationale, architecture notes, and engineering ADRs;
- `repo-specs/` owns product and business planning records, including suite-local ADRs; and
...
- [A-Commerce specifications index](../../repo-specs/a-commerce/README.md)
- [A-Commerce PRD](../../repo-specs/a-commerce/prd.md)
- [A-Commerce SRS](../../repo-specs/a-commerce/srs.md)
- [A-Commerce PDP/WBS](../../repo-specs/a-commerce/pdp-wbs.md)
- [A-Commerce test strategy and acceptance plan](../../repo-specs/a-commerce/test-plan.md)
