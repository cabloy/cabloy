...
- `repo-docs-internal/architecture/`
- `repo-docs-internal/decisions/`
...
Do not use `repo-docs-internal/` for:
...
- use `repo-docs-internal/architecture/` for stable technical explanations
- use `repo-docs-internal/decisions/` for important design and refactor records
