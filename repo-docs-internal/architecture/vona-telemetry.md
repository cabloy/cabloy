...
- [Telemetry Guide](../../repo-docs/backend/telemetry-guide.md) covers user-facing deployment configuration and custom-span usage.
- [Logger Guide](../../repo-docs/backend/logger-guide.md) covers logger clients, levels, rotation, and operational logging behavior.
