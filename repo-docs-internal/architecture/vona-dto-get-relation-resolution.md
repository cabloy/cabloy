...
- [Vona Module Dependencies](../../repo-docs/backend/module-dependencies.md)
- [Backend Foundation](../../repo-docs/backend/foundation.md#scope-lookup-vs-module-dependencies)
