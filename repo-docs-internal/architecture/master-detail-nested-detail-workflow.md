...
- the public workflow doc in `repo-docs/backend/master-detail-workflow.md`
- the public source-reading companion in `repo-docs/backend/master-detail-source-reading-map.md`
...
This belongs in `repo-docs/` because both people and agents need the operational explanation.
...
This belongs in `repo-docs-internal/` because it is maintainer-facing rationale, not the main public playbook.
...
1. read `repo-docs/backend/master-detail-workflow.md`
2. read `repo-docs/backend/master-detail-source-reading-map.md`
3. inspect:
...
- `repo-docs/backend/master-detail-workflow.md`
- `repo-docs/backend/master-detail-source-reading-map.md`
