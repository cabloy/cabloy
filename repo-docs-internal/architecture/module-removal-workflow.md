...
- the public module-removal playbook in `repo-docs/`
...
This belongs in `repo-docs/` because both people and agents may need the operational explanation.
...
This belongs in `repo-docs-internal/` because it is maintainer-facing rationale, not user-facing workflow explanation.
